...
describe("New Todo Input Test", () => {
    ...
    describe("Normal New Todo Input Component", () => {
        ...
        it("should not call addTodo function of props when click Add button while text input is empty", function() {
            addButton = newTodoInput.find("input[type='button']");
        ...
        it("should call addTodo function of props when click Add button while text input has content", function() {
            textInput = newTodoInput.find("input[type='text']");
            addButton = newTodoInput.find("input[type='button']");
        ...
        it("should text input be empty after add button clicked", function() {
            textInput = newTodoInput.find("input[type='text']");
            addButton = newTodoInput.find("input[type='button']");
            textInput.instance().value = "Learn Spring Boot";
            addButton.simulate("click");
